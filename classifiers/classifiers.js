...
(function () {
  ...
  // ── Excel (.xlsx) ──
  /* Пакувальник — у спільному модулі pmg-xlsx.js: той самий код лежав
     копіями тут, у nk026.js і в porivnyannya.js. Тут лишається тільки те,
  ...
  function downloadXlsx() {
    ...
    window.PMG_XLSX.download({
      filename: "nk025_" + (window.PMG_XLSX.slug(exportWhat, 40) || "eksport"),
      name: "НК 025", head, rows, widths, freeze: true,
    });
  }

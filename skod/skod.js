...
// Посади підписантів лишаються, прізвища — ні: репозиторій публічний.
// Підпис ставлять від руки; за потреби підставимо з окремої таблиці Supabase.
const TABEL_SIGNERS = [
  ['Головний спеціаліст відділу розрахунку вартості медичних послуг', ''],
  ['Директор Департаменту стратегії універсального охоплення \nнаселення медичними послугами', ''],
  ['Управління персоналу та організаційної культури', '']
];
